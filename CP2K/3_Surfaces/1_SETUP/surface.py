...
if "--help" in sys.argv or "-h" in sys.argv or len(sys.argv) != 9:
    print("Usage: python3 surface.py unit_cell repeat_x repeat_y thickness midx_a midx_b midx_c vacuum")
